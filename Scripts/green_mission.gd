...
@export var enemy_blue_scene: PackedScene = preload("res://Scenes/enemy_green.tscn")
...
@export var enemies_per_wave := 2 * Global.level[2] 
...
func spawn_single_enemy() -> void:
	var enemy = enemy_blue_scene.instantiate()
